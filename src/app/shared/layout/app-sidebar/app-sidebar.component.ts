...
export class AppSidebarComponent implements OnInit, OnDestroy {
  ...
  public menuItems: MenuItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C9.23858 2 7 4.23858 7 7C7 7.53043 7.10379 8.03914 7.29289 8.5C5.94374 9.02766 5 10.3876 5 12C5 14.2091 6.79086 16 9 16H10V20H8.5C8.22386 20 8 20.2239 8 20.5C8 20.7761 8.22386 21 8.5 21H15.5C15.7761 21 16 20.7761 16 20.5C16 20.2239 15.7761 20 15.5 20H14V16H15C17.2091 16 19 14.2091 19 12C19 10.3876 18.0563 9.02766 16.7071 8.5C16.8962 8.03914 17 7.53043 17 7C17 4.23858 14.7614 2 12 2Z" fill="currentColor"/></svg>`,
      name: 'Plantas',
      path: '/plantas',
    },
    {
