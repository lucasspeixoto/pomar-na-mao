...
export class AppSidebarComponent implements OnInit, OnDestroy {
  ...
  navItems: NavItem[] = [
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3L3 10H6V20H18V10H21L12 3Z M10 14H14V20H10V14Z M6.5 12.5H9V15.5H6.5V12.5Z M15 12.5H17.5V15.5H15V12.5Z" fill="currentColor"/></svg>`,
      name: 'Início',
      path: '/inicio',
    },
    {
