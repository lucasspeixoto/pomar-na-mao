      ...
      <div class="flex w-full justify-between items-center mx-4 gap-2">
        ...
        <div routerLink="/coleta-offline" class="cursor-pointer flex flex-col items-center gap-2">
          <i
            ...
            style="font-size: 1.6rem; color: green"></i>
          <span class="hover:underline font-bold text-black">Coletar</span>
        </div>
        <!-- Detectar -->
        <div class="cursor-pointer flex flex-col items-center gap-2">
          <i
            ...
            style="font-size: 1.6rem; color: green"></i>
          <span class="hover:underline font-bold text-black">Detectar</span>
        </div>
        <!-- Coletas -->
        <div class="cursor-pointer flex flex-col items-center gap-2">
          <i
            ...
            style="font-size: 1.6rem; color: green"></i>
          <span class="hover:underline font-bold text-black">Consutar</span>
        </div>
      </div>
    </p-toolbar>
  `,
